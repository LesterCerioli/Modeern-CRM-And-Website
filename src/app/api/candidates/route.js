...
const DOCUMENT_FORMATS = {
  AE: { pattern: /^[A-Z]{1}[0-9]{7}$/, description: '1 letter + 7 digits', example: 'A1234567' },
  ...
  CN: { pattern: /^[GE]\d{8}$/, description: 'G/E + 8 digits', example: 'G12345678' },
  DE: { pattern: /^[CFGHJKLMNPRTVWXYZ0-9]{9}$/, description: '9 alphanumeric chars', example: 'C01X000T7' },
  EG: { pattern: /^[A-Z]{1}[0-9]{8}$/, description: '1 letter + 8 digits', example: 'A12345678' },
  ...
  IN: { pattern: /^[A-Z][0-9]{7}$/, description: '1 letter + 7 digits', example: 'A1234567' },
  ...
  KE: { pattern: /^[A-Z]{1}[0-9]{7}$/, description: '1 letter + 7 digits', example: 'A1234567' },
  ...
  NG: { pattern: /^[A-Z]{1}[0-9]{8}$/, description: '1 letter + 8 digits', example: 'A12345678' },
  ...
  SA: { pattern: /^[A-Z]{1}[0-9]{7}$/, description: '1 letter + 7 digits', example: 'A1234567' },
  ...
  ZA: { pattern: /^[A-Z]{1}[0-9]{8}$/, description: '1 letter + 8 digits', example: 'A12345678' },
